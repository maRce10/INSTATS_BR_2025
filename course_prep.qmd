...
### Critical software {.unnumbered .unlisted}
...
4)  Make a directory called "BIAC04", this will be your working directory for the course.
...
7)  Also in Rstudio: Go back up to the "File" tab and select "New Project", then select the "BIAC04" directory.
...
### Non-critical software (not needed for most of the course) {.unnumbered .unlisted}

1) Install ffmpeg (only needed for dynaSpec package, not critical):
...
2) Install Audacity (not critical, you can use Adobe Audition instead):

<https://www.audacityteam.org/download/>

3) Install SOX. It can be downloaded from here (not critical but could be useful): [http://sox.sourceforge.net](http://sox.sourceforge.net/) (*Not critical*)

4) Install FLAC. It can be downloaded from here (also not critical): [https://xiph.org/flac/download.html](http://sox.sourceforge.net/) (*Not critical*)



Note that you can also run the code using google colab. Take a look at this notebook: [https://colab.research.google.com/](https://colab.research.google.com/drive/13Hb4sdvg6FgQi0pF1Z-Y2UrirVPpNJjb?usp=sharing)
